...
use_gpu = 1;
caffe('set_device', 0);
model_def_file = '/home/cv/image-net/caffe/models/depth_enhancement/feature_extraction_deploy.prototxt';
model_file = '/home/cv/image-net/caffe/models/depth_enhancement/snapshots-2x-finetune/dsrcnn_iter_42000.caffemodel';
batch_size = 1;
